...
class Evaluator(object):
    ...
    def _score_computation(self, el_mode):
        ...
        return micro_pr, micro_re, micro_f1, macro_pr, macro_re, macro_f1, micro_tp, micro_fp, micro_fn

    def print_log_results(self, tf_writer, eval_cnt, el_mode):
        micro_pr, micro_re, micro_f1, macro_pr, macro_re, macro_f1, micro_tp, micro_fp, micro_fn = self._score_computation(el_mode)

        print("micro", "P: %.1f" % micro_pr, "\tR: %.1f" % micro_re, "\tF1: %.1f" % micro_f1)
        print("micro", "TP: %.1f" % micro_tp, "\tFP: %.1f" % micro_fp, "\tFN: %.1f" % micro_fn)
