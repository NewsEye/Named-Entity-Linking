...
if __name__ == "__main__":
    ...
    if args.print_predictions:
        ...
        printPredictions = PrintPredictions(args.language,config.base_folder+"data/tfrecords/"+args.language+"/"+args.experiment_name+"/",
                args.predictions_folder, args.entity_extension,args.gm_bucketing_pempos, args.print_global_voters,args.print_global_pairwise_scores)
    evaluate()
