...
def _parse_args():
    ...
    parser.add_argument("--wiki_folder", default="../data/basic_data/test_datasets/wikiann/")
...
if __name__ == "__main__":
    ...
    process_wiki(args.wiki_folder+"wikiann-"+args.language+"-train.conll", args.output_folder+"wikiann-"+args.language+"-train.conll", args.language)
    process_wiki(args.wiki_folder+"wikiann-"+args.language+"-dev.conll", args.output_folder+"wikiann-"+args.language+"-dev.conll", args.language)
    process_wiki(args.wiki_folder+"wikiann-"+args.language+"-test.conll", args.output_folder+"wikiann-"+args.language+"-test.conll", args.language)
