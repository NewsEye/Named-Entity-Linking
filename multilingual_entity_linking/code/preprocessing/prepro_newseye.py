...
def process_wiki(in_filepath, out_filepath, language):
    ...
    print("process_wiki     ent_id_changes: ", ent_id_changes)
...
def _parse_args():
    ...
    parser.add_argument("--newseye_folder", default="../data/basic_data/test_datasets/newseye/")
...
if __name__ == "__main__":
    ...
    output_folder = args.output_folder + args.language + "/"
    process_wiki(args.newseye_folder+"/train-"+language+".conll", output_folder+language+"-train.conll", args.language)
    process_wiki(args.newseye_folder+"/dev-"+language+".conll", output_folder+language+"-dev.conll", args.language)
    process_wiki(args.newseye_folder+"/test-"+language+".conll", output_folder+language+"-test.conll", args.language)
